...
MAX_SIGNAL_CLOSE_POSITION = float(os.getenv("MAX_SIGNAL_CLOSE_POSITION", 0.88))
...
LATE_ENTRY_SCORE_PENALTY = float(os.getenv("LATE_ENTRY_SCORE_PENALTY", 2))
...
MAX_LIVE_ENTRY_CLOSE_POSITION = float(
    os.getenv("MAX_LIVE_ENTRY_CLOSE_POSITION", 0.88)
)
