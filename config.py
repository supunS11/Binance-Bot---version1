...
STATIC_TP_ROI = float(os.getenv("STATIC_TP_ROI", 3))
ADAPTIVE_TP_ENABLED = env_bool("ADAPTIVE_TP_ENABLED", "True")
MIN_TRADE_RR = float(os.getenv("MIN_TRADE_RR", 0.6))
...
SCALP_TP_RESPECT_SR = env_bool("SCALP_TP_RESPECT_SR", "True")
SCALP_TP_SR_BUFFER_PCT = float(os.getenv("SCALP_TP_SR_BUFFER_PCT", 0.04))
...
MAX_SIGNAL_REJECTION_WICK_RATIO = float(
    os.getenv("MAX_SIGNAL_REJECTION_WICK_RATIO", 0.55)
)
SIGNAL_MOMENTUM_FILTER_ENABLED = env_bool(
    "SIGNAL_MOMENTUM_FILTER_ENABLED",
    "True"
)
MIN_SIGNAL_MOMENTUM_ATR = float(os.getenv("MIN_SIGNAL_MOMENTUM_ATR", 0.03))
...
STRUCTURE_SL_LOOKBACK = int(os.getenv("STRUCTURE_SL_LOOKBACK", 8))
STRUCTURE_SL_ATR_BUFFER_MULT = float(os.getenv("STRUCTURE_SL_ATR_BUFFER_MULT", 0.25))
STRUCTURE_SL_MIN_ATR_MULT = float(os.getenv("STRUCTURE_SL_MIN_ATR_MULT", 0.55))
STRUCTURE_SL_MAX_ATR_MULT = float(
    os.getenv("STRUCTURE_SL_MAX_ATR_MULT", FLOW_SL_ATR_MULT)
)
...
EARLY_FLOW_EXIT_MINUTES = float(os.getenv("EARLY_FLOW_EXIT_MINUTES", 3))
...
BREAKEVEN_SL_ENABLED = env_bool("BREAKEVEN_SL_ENABLED", "True")
BREAKEVEN_TRIGGER_TP_PCT = float(os.getenv("BREAKEVEN_TRIGGER_TP_PCT", 40))
BREAKEVEN_LOCK_ROI = float(os.getenv("BREAKEVEN_LOCK_ROI", 0.35))
PROFIT_LOCK_SL_ENABLED = env_bool("PROFIT_LOCK_SL_ENABLED", "True")
PROFIT_LOCK_TRIGGER_TP_PCT = float(os.getenv("PROFIT_LOCK_TRIGGER_TP_PCT", 65))
PROFIT_LOCK_SL_TP_PCT = float(os.getenv("PROFIT_LOCK_SL_TP_PCT", 35))
...
CLOSE_ON_OPPOSITE_SIGNAL_ENABLED = env_bool(
    "CLOSE_ON_OPPOSITE_SIGNAL_ENABLED",
    "False"
)
MARKET_REVERSAL_EXIT_ENABLED = env_bool("MARKET_REVERSAL_EXIT_ENABLED", "False")
MARKET_REVERSAL_EXIT_MINUTES = float(os.getenv("MARKET_REVERSAL_EXIT_MINUTES", 10))
MARKET_REVERSAL_EXIT_MIN_ADX = float(os.getenv("MARKET_REVERSAL_EXIT_MIN_ADX", 18))
MARKET_REVERSAL_EXIT_MIN_ROI = float(os.getenv("MARKET_REVERSAL_EXIT_MIN_ROI", 1.0))
MARKET_REVERSAL_EXIT_CONFIRM_BTC = env_bool(
    "MARKET_REVERSAL_EXIT_CONFIRM_BTC",
    "False"
)
...
OPEN_TRADES_STATE_PATH = os.getenv(
